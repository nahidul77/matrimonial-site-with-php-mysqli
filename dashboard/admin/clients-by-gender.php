...
$server = new Admin();
$result = $server->clients_byGender();
$result2 = $server->clients_byGender();
                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-4 col-3">
                            <form method="POST" action="client-search-result.php">
                                <table>
                                    <td><input type="" placeholder="Client's ID..." name="client_id" list="ID" class="form-control" style="min-width: 200px" autocomplete="off" required></td>
                                    <td><input type="submit" value="Search" name="view" class="btn btn-primary" style="height: 40px"></td>
                        ...
                        <div class="col-sm-8 col-9 text-right m-b-20">
                            <a href="filter-clients.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-filter"></i> Filter Clients</a>
                        </div>
                    </div>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <div class="col-md-4 col-sm-4  col-lg-3">
                                    <div class="profile-widget">
                                        ...
                                        <div class="doc-prof"><?php echo $row['current_city'] ?>, <?php echo $row['current_country'] ?></div>
                                        <br/>
                                        <?php if ($row['status'] == 1) { ?>
