...
if (isset($_GET['search'])) {
    $output = $server->searchProfiles($_GET);
}
            ...
            <div class="page-wrapper">
                <div class="content">
                    <div class="row">
                        <div class="col-sm-6">
                            <h4 class="page-title">
                                <u>All PROFILES</u>&nbsp;<i class="fa fa-users"></i>
                                <?php echo $message; ?>
                            </h4>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-1">
                                            <table>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <tr>
                                                        <td><a href="client-profile.php?client_id=<?php echo $row['client_id'] ?>"><button class="btn btn-primary" title="Profile"><i class="fa fa-user"></i></button></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <?php if ($row['client_id'] == $server->accepted($row['client_id'])) { ?>
                                                    ...
                                                    <tr>
                                                        <td><a href=""><button class="btn btn-secondary" title="Like"><i class="fa fa-heart" style="color:red"></i></button></a></td>
                                                    </tr>
