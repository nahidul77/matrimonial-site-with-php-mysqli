                ...
                <div class="content">
                    <div class="row">
                        <div class="col-sm-6 col-3">
                            <h4 class="page-title"><u>Requests</u><?php echo $message; ?></h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title d-inline-block text-danger">Requested Ones[ <?php echo $server->total_requested_ones(); ?> ]</h4>
                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <?php if ($payment_status == 0) { ?>
                                                                    <a href="#modal1" class="avatar"><img src="<?php echo $server->clientIamge_byID($row['request_to']) ?>" onerror="this.onerror=null; this.src='assets/img/user.jpg'"/></a>
                                                                    <h2><a href="#modal1"><?php echo $server->clientName_byID($row['request_to']) ?></a></h2>
                                                            ...
                                                            <td>
                                                                <h5 class="time-title p-0">Connected From</h5>
                                                                <p><?php echo $row['accepted_time'] ?></p>
                                                            </td>
                                                            <td class="text-right">
                                                                <?php if ($payment_status == 0) { ?>
                                                                    <a href="#modal1" class="btn btn-outline-primary" title="Send Message" ><i class="fa fa-envelope-o"></i></a>
                                                                    <a href="#modal1" class="btn btn-outline-danger" title="Send Message" ><i class="fa fa-user-times"></i></a>
                                                                        
                                                                <?php } else { ?>
                                                                    <form method="POST" action="" >
                                                                        <input type="hidden" value="<?php echo $row['request_to'] ?>" name="client_id" />
                                                                        <a href="chat.php?message_to=<?php echo $row['request_to'] ?>" class="btn btn-outline-primary" title="Send Message" ><i class="fa fa-envelope-o"></i></a>
                                                                        <button type="submit" class="btn btn-outline-danger" title="Remove" name="cancel" onclick="return confirm('Are you sure to cancel?');"><i class="fa fa-user-times"></i></button>
                                                                    </form>
                                                                <?php } ?>
                                                            </td>
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title d-inline-block text-success">Accepted Ones [ <?php echo $server->total_accepted_ones(); ?> ]</h4>
                                </div>
                                <div class="card-body p-0" style="min-height: 450px;max-height: 450px;overflow: auto">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <?php } else { ?>
                                                                    <form method="POST" action="" >
                                                                        ...
                                                                        <a href="chat.php?message_to=<?php echo $row['request_from'] ?>" class="btn btn-outline-primary" title="Send Message"><i class="fa fa-envelope-o"></i></a>
                                                                        <button type="submit" class="btn btn-outline-danger" title="Remove" name="cancel" onclick="return confirm('Are you sure to cancel?');"><i class="fa fa-user-times"></i></button>
                                                                    </form>
                                                                <?php } ?>
